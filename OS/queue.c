 ...
 */
static Queue_t *prvAllocateQueueMemory(const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize,
                                       uint8_t ** ppucQueueStorage, StaticQueue_t * pxStaticQueue) PRIVILEGED_FUNCTION;
...
static Queue_t *prvAllocateQueueMemory(const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize,
                                       uint8_t ** ppucQueueStorage, StaticQueue_t * pxStaticQueue)
{
    Queue_t *pxNewQueue;
                                            ...
                                            StaticQueue_t * pxStaticQueue)
{
    ...
    xHandle =
        xQueueGenericCreate(uxMaxCount, queueSEMAPHORE_QUEUE_ITEM_LENGTH, NULL, pxStaticQueue,
